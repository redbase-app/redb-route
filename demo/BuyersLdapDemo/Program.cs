...
//
//  Manual testing (after launch). Replace alice@example.com / bob@example.com
...
//    POST (upload buyers):
//      curl.exe -X POST http://localhost:5099/api/buyers -H "Content-Type: application/json" -d '[{\"login\":\"alice@example.com\",\"role\":\"Buyer\"},{\"login\":\"bob@example.com\",\"role\":\"Admin\"}]'
//    GET (list from DB):
//      curl.exe http://localhost:5099/api/buyers
//
//  --- PowerShell without curl (native) ---
//    $body = '[{"login":"alice@example.com","role":"Buyer"},{"login":"bob@example.com","role":"Admin"}]'
...
//  --- cmd.exe ---
//    POST:
//      curl -X POST http://localhost:5099/api/buyers -H "Content-Type: application/json" -d "[{\"login\":\"alice@example.com\",\"role\":\"Buyer\"},{\"login\":\"bob@example.com\",\"role\":\"Admin\"}]"
//    GET:
...
// ─── 0. Settings. Fill in with your own AD / database values ─────────────────
// LDAP — point at your Active Directory / LDAP server.
const string LdapServer = "ldap.example.com";
const int LdapPort = 389;
const string LdapBaseDn = "DC=example,DC=com";
