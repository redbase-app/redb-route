...
public sealed class RedisBuilder
{
    ...
    public RedisBuilder Connection(string connectionString) { _connectionString = connectionString; return this; }
    ...
    public RedisBuilder Password(string password) { _password = password; return this; }
    ...
    public RedisBuilder ConnectionFactory(string name) { _connectionFactory = name; return this; }
    ...
    public RedisBuilder Field(string field) { _field = field; return this; }
    ...
    public RedisBuilder Member1(string member) { _member1 = member; return this; }
    ...
    public RedisBuilder Member2(string member) { _member2 = member; return this; }
    ...
    public RedisBuilder ConsumerGroup(string group) { _consumerGroup = group; return this; }
    ...
    public RedisBuilder ConsumerName(string name) { _consumerName = name; return this; }
