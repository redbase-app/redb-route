...
public sealed class MqttBuilder
{
    ...
    /// When &gt; 1, messages are processed by a pool of N workers and acknowledged only after each
    /// worker finishes (manual ack) — parallelism with at-least-once preserved for QoS 1/2.
