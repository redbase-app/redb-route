...
/// <summary>
/// Predicate that checks whether an expression result is greater than or equal to a given value.
/// </summary>
public class GreaterThanOrEqualPredicate : IPredicate
{
    ...
    public GreaterThanOrEqualPredicate(IExpression expression, object value)
    {
