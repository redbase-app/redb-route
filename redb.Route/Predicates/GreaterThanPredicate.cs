...
/// <summary>
/// Predicate that checks whether an expression result is greater than a given value.
/// </summary>
public class GreaterThanPredicate : IPredicate
{
    ...
    public GreaterThanPredicate(IExpression expression, object value)
    {
