...
/// <summary>
/// Predicate that checks whether an expression result is less than or equal to a given value.
/// </summary>
public class LessThanOrEqualPredicate : IPredicate
{
    ...
    public LessThanOrEqualPredicate(IExpression expression, object value)
    {
